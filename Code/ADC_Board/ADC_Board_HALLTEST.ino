...
//  float tPhase1 = micros();
  byte inByteA, inByteB, inByteC, inByteD, inByteE, inByteF, inByteG, inByteH, inByteI, inByteJ, inByteJ, inByteL = 0;
 ...
 /* HALL SPIN -- phase 3 --*/
  ...
  Serial.print(dataSpin, DEC),Serial.print(","),Serial.println(lastTemp,2);
  cnt++; 
  delay(dTime);
}
/*------------------------------------------------*/
