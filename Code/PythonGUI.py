...
idac1label = tk.Label(root, text="+", font=LARGE_FONT)
...
idac2label = tk.Label(root, text="GND", font=LARGE_FONT)
...
idaclabel = tk.Label(root, text="IDAC Current", font=LARGE_FONT)
...
dVar_vbias.set("Supply/2")
vbias_dropdown = OptionMenu(root, dVar_vbias, "Supply/2", "Supply/12")
